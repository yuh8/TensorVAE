...
class TensorVAE(Model):
    def compile(self, optimizer, metrics, kl_weight):
        super(TensorVAE, self).compile()
...
if __name__ == "__main__":
    ...
    create_folder("g_net")
    train_path = 'D:/tensor_vae/train_data/train_batch/'
    val_path = 'D:/tensor_vae/test_data/val_batch/'
    ...
    transvae = TensorVAE(inputs=X, outputs=[z_mean, z_log_var, r_pred])
